...
class Tx_Client_Box extends Element_El_Widget {
    ...
    public function get_title() {
        return __( 'TX Client Box', 'barsi-core' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            'client_quantity',
            [
                'label'   => __( 'Client Quantity', 'barsi-core' ),
        ...
        $this->add_control(
            'client_info_text',
            [
                'label'   => __( 'Client Info Text', 'barsi-core' ),
