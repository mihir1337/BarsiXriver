<div class="pf-cta-2-col d-flex align-items-center justify-content-center wa-bg-default wascale0 tx-section" data-background="<?php echo $settings['image_1']['url'] ? esc_url($settings['image_1']['url']) : ''; ?>">
	<div class="pf-cta-2-content">
		<div class="content">
		...
		<div class="btn-wrap">
			<a href="<?php echo esc_url($settings['button_link']['url']); ?>"
                ...
                rel="<?php echo esc_attr($settings['button_link']['nofollow'] ? 'nofollow' : ''); ?>" aria-label="name" class="pf-pr-2 tx-button">
