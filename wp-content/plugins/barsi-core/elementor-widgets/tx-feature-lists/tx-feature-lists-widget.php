...
class Tx_Feature_Lists extends Element_El_Widget {
    ...
    public function get_title() {
        return __( 'TX Feature Lists', 'barsi-core' );
    }
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            'feature_image',
            [
                'label'       => __( 'Feature Image', 'barsi-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'feature_text' => __( 'Info Text', 'barsi-core' ),
                    ],
                ],
