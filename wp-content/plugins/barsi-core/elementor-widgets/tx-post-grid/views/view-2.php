<section class="bs-blog-2-area mb-140 tx-section">
    <div class="container bs-container-1">
        <div class="bs-blog-2-border">
            <!-- section-title -->
            <div class="bs-blog-2-sec-title mb-60 text-center">
            ...
            <div class="bs-blog-2-wrap">
                ...
                <?php
                    ...
                    $count = $inx + 1;
                ?>
                <div class="bs-blog-2-item wa-skew-1">
                    <?php if(!empty( $thumb && $settings['feature_image'] === 'yes' )) : ?>
                    <div class="item-img wa-fix wa-img-cover" data-cursor-text="<?php echo esc_attr__('View', 'barsi-core'); ?>">
