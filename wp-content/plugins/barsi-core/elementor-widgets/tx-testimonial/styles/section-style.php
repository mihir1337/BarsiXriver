...
$this->add_control(
    'service_after_section_background',
    [
        'label'     => esc_html__( 'Bottom Bg Color', 'Text-domain' ),
...
$this->add_group_control(
    \Elementor\Group_Control_Background::get_type(),
    [
        'name'     => 'service_after_section_background',
        'label'    => __( 'Background', 'gilroy-core' ),
        'types'    => ['classic', 'gradient'],
        'selector' => '{{WRAPPER}} .pf-testimonial-5-area::after',
    ]
);
