 ...
 */
    ...
    $blog_button_text = cs_get_option( 'blog_button_text', __('Read More', 'barsi') );
    $excerpt_length = cs_get_option( 'excerpt_length', 180 );

    // post read time
    $post_read_time = barsi_post_read_time();
...
?>
        ...
        <div class="blog-details-page-content">
            <div class="blog-details-item">
                <div class="tx-blogDetails-box__wrapper">
                    <div class="post-details-content log-blog-details-text">
                        <?php the_content(); ?>
                    </div>
                    <div class="post-page-wrapper">
                        <?php
                            wp_link_pages( [
                                'before'      => '<div class="page-links mt-40 mb-55">' . esc_html__( 'Pages:', 'barsi' ),
                                'after'       => '</div>',
    ...
    <div class="bs-blog-page-3-item-single">
        <!-- img -->
        <?php if ( has_post_thumbnail() ): ?>
        <div class="item-img wa-fix wa-img-cover wa-p-relative mb-30">
            <?php the_post_thumbnail( 'full', ['class' => 'img-responsive w-100'] ); ?>
        </div>
        <?php endif; ?>

        <!-- meta -->
        <div class="item-meta pt-0">
        ...
        <?php endif; ?>
            ...
            <a href="<?php the_permalink(); ?>" class="item-btn bs-h-4">
            <?php echo esc_html($blog_button_text); ?>
                <i>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5838 8.24989C12.8284 8.24989 11.2286 6.58413 11.2286 4.75488V4.00488H9.78855V4.75488C9.78855 6.08538 10.3487 7.33338 11.2278 8.24989H2.34375V9.74989H11.2278C10.3487 10.6664 9.78855 11.9144 9.78855 13.2449V13.9949H11.2286V13.2449C11.2286 11.4156 12.8284 9.74989 14.5838 9.74989H15.3038V8.24989H14.5838Z" fill="white"/>
                        </svg>
                </i>
            </a>
            <?php endif; ?>
